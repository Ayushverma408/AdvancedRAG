...
# ── Single-book system prompt (legacy, kept for backwards compat) ─────────────
...
# Keep build_multi_book_generator as an alias for backwards compat (used by legacy /query endpoint)
